<?php
    ...
    include("./header.php");
?>
            <form action="VPN.php" method="POST">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-3">
                            <h2>Account</h2>
                            <p>Please fill out details to add to the VPN</p>
                            <div>
                            ...
                            <div>
                                ...
                                <input class = "form-control" name="No_of_devices" type="number" min="1" required>
                            </div>
                            <div>
                                <label for="loactions">Location</label>
                                <form action="" method="post" class="mb-3" required>
                                        <select name="country[]" id = "options" multiple>
                                                ...
                                                $no_of_devices = $_POST['No_of_devices'];
                                                    ...
                                                    if(!empty($_POST['country'])) {
                                                      foreach($_POST['country'] as $selected){
                                                        ...
                                                        $query ="INSERT INTO VPN(email,website,No_of_devices,locations) VALUES ('".mysqli_real_escape_string($conn,$email)."','$website', '$no_of_devices', '$country');";
